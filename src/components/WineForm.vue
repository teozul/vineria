<template>
    <form @submit.prevent="handleSubmit" class="wine-form">
          ...
          <div class="form-col">
            <div class="form-group">
              ...
              <input 
                type="text" 
                id="denomination" 
                v-model="wineSheet.denomination" 
                class="form-control" 
                required
              />
            </div>
        ...
        <div class="form-row">
          <div class="form-col">
            <div class="form-group">
              ...
              <select 
                id="classification" 
                v-model="wineSheet.classification" 
                class="form-control" 
                required
              >
          ...
          <div class="form-col">
            <div class="form-group">
              ...
              <input 
                type="number" 
                id="alcoholContent" 
                v-model="wineSheet.alcoholContent" 
                class="form-control" 
                step="0.1" 
                min="0" 
                max="30" 
        ...
        <div class="form-row">
          <div class="form-col">
            <div class="form-group">
              ...
              <select 
                id="limpidity" 
                v-model="wineSheet.visualExam.limpidity" 
                class="form-control" 
                required
              >
          ...
          <div class="form-col">
            <div class="form-group">
              ...
              <select 
                id="transparency" 
                v-model="wineSheet.visualExam.transparency" 
                class="form-control" 
                required
              >
        ...
        <div class="form-row">
          <div class="form-col">
            <div class="form-group">
              ...
              <select 
                id="colorTone" 
                v-model="wineSheet.visualExam.color.tone" 
                class="form-control" 
                required
              >
          ...
          <div class="form-col">
            <div class="form-group">
              ...
              <select 
                id="colorIntensity" 
                v-model="wineSheet.visualExam.color.intensity" 
                class="form-control" 
                required
              >
        ...
        <div class="form-row">
          <div class="form-col">
            <div class="form-group">
              ...
              <select 
                id="fluidity" 
                v-model="wineSheet.visualExam.fluidity" 
                class="form-control" 
                required
              >
      ...
      <div class="form-section">
          ...
          <div class="form-col">
            <div class="form-group">
              ...
              <select 
                ...
                v-model="wineSheet.olfactoryExam.intensity" 
                class="form-control" 
                required
              >
          ...
          <div class="form-col">
            <div class="form-group">
              ...
              <select 
                ...
                v-model="wineSheet.olfactoryExam.quality.franchness" 
                class="form-control" 
                required
              >
          ...
          <div class="form-col">
            <div class="form-group">
              ...
              <select 
                ...
                v-model="wineSheet.olfactoryExam.quality.fineness" 
                class="form-control" 
                required
              >
        ...
        <div class="form-group">
          ...
          <select 
            ...
            v-model="wineSheet.olfactoryExam.complexity" 
            class="form-control" 
            required
          >
      ...
      <div class="form-section">
        ...
        <div class="form-group">
          ...
          <select 
            id="body" 
            v-model="wineSheet.gustatoryExam.body" 
            class="form-control" 
            required
          >
        ...
        <div class="form-row">
          <div class="form-col">
            <div class="form-group">
              ...
              <select 
                id="alcoholLevel" 
                v-model="wineSheet.gustatoryExam.softElements.alcoholLevel" 
                class="form-control" 
                required
              >
          ...
          <div class="form-col">
            <div class="form-group">
              ...
              <select 
                id="softness" 
                v-model="wineSheet.gustatoryExam.softElements.softness" 
                class="form-control" 
                required
              >
          ...
          <div class="form-col">
            <div class="form-group">
              ...
              <select 
                id="sugars" 
                v-model="wineSheet.gustatoryExam.softElements.sugars" 
                class="form-control" 
                required
              >
        ...
        <div class="form-row">
          <div class="form-col">
            <div class="form-group">
              ...
              <select 
                id="acidity" 
                v-model="wineSheet.gustatoryExam.hardElements.acidity" 
                class="form-control" 
                required
              >
          ...
          <div class="form-col">
            <div class="form-group">
              ...
              <select 
                id="salinity" 
                v-model="wineSheet.gustatoryExam.hardElements.salinity" 
                class="form-control" 
                required
              >
          ...
          <div class="form-col">
            <div class="form-group">
              ...
              <select 
                id="tannins" 
                v-model="wineSheet.gustatoryExam.hardElements.tannins" 
                class="form-control" 
                required
              >
        ...
        <div class="form-group">
          ...
          <select 
            id="balance" 
            v-model="wineSheet.gustatoryExam.balance" 
            class="form-control" 
            required
          >
        ...
        <div class="form-row">
          <div class="form-col">
            <div class="form-group">
              ...
              <select 
                id="retroIntensity" 
                v-model="wineSheet.gustatoryExam.retroOlfactory.intensity" 
                class="form-control" 
                required
              >
                <option v-for="(value, key) in olfactoryIntensityOptions" :key="key" :value="value">
          ...
          <div class="form-col">
            <div class="form-group">
              ...
              <select 
                id="retroQuality" 
                v-model="wineSheet.gustatoryExam.retroOlfactory.quality" 
                class="form-control" 
                required
              >
          ...
          <div class="form-col">
            <div class="form-group">
              ...
              <select 
                id="retroPersistence" 
                v-model="wineSheet.gustatoryExam.retroOlfactory.mouthAroma.persistence" 
                class="form-control" 
                required
              >
      ...
      <div class="form-section">
        ...
        <div class="form-group">
          ...
          <select 
            ...
            v-model="wineSheet.evolutionaryState" 
            class="form-control" 
            required
          >
        ...
        <div class="form-group">
          ...
          <textarea 
            ...
            v-model="wineSheet.finalConsiderations" 
            class="form-control" 
            rows="4"
          ></textarea>
        </div>
  ...
  const emit = defineEmits<{
    (e: 'submit', data: WineTastingSheet): void;
    (e: 'cancel'): void;
  }>();
  ...
  // State
  const wineSheet = reactive<WineTastingSheet>(
    props.initialData ? { ...props.initialData } : createEmptyWineTastingSheet()
  );
  const submitting = ref(false);
  const isSparklingWine = ref(false);
  ...
  const effervescenceGrain = ref<string>(
    wineSheet.visualExam.effervescence?.grain || EffervescenceGrain.Fine
  );
  
  const effervescencePersistence = ref<string>(
    wineSheet.visualExam.effervescence?.persistence || EffervescencePersistence.Persistent
  );
  
  // Handle aroma types as a separate array for checkboxes
  const selectedAromaTypes = ref<string[]>(
    wineSheet.olfactoryExam.aromaTypes.map(type => type)
  );
  
  // Watch for changes in sparklingWine checkbox
  watch(isSparklingWine, (newValue) => {
    if (newValue) {
      wineSheet.visualExam.effervescence = {
        grain: effervescenceGrain.value as EffervescenceGrain,
        persistence: effervescencePersistence.value as EffervescencePersistence
      };
    } else {
      wineSheet.visualExam.effervescence = undefined;
    }
  });
  ...
  watch([effervescenceGrain, effervescencePersistence], ([newGrain, newPersistence]) => {
    if (isSparklingWine.value) {
      wineSheet.visualExam.effervescence = {
        grain: newGrain as EffervescenceGrain,
        persistence: newPersistence as EffervescencePersistence
      };
    }
  });
  
  // Watch for changes in selected aroma types
  watch(selectedAromaTypes, (newAromaTypes) => {
    wineSheet.olfactoryExam.aromaTypes = newAromaTypes as AromaType[];
  });
  
  // Initialize values on component mount
  onMounted(() => {
    isSparklingWine.value = !!wineSheet.visualExam.effervescence;
    
    // Adjust color tone options based on wine type
    if (wineSheet.wineType === 'Bianco' && !isWhiteWineColorTone(wineSheet.visualExam.color.tone)) {
      wineSheet.visualExam.color.tone = ColorTone.StrawYellow;
    } else if (wineSheet.wineType === 'Rosé' && !isRoseWineColorTone(wineSheet.visualExam.color.tone)) {
      wineSheet.visualExam.color.tone = ColorTone.CherryPink;
    } else if (wineSheet.wineType === 'Rosso' && !isRedWineColorTone(wineSheet.visualExam.color.tone)) {
      wineSheet.visualExam.color.tone = ColorTone.RubyRed;
    }
  });
  ...
  watch(() => wineSheet.wineType, (newWineType) => {
    if (newWineType === 'Bianco' && !isWhiteWineColorTone(wineSheet.visualExam.color.tone)) {
      wineSheet.visualExam.color.tone = ColorTone.StrawYellow;
    } else if (newWineType === 'Rosé' && !isRoseWineColorTone(wineSheet.visualExam.color.tone)) {
      wineSheet.visualExam.color.tone = ColorTone.CherryPink;
    } else if (newWineType === 'Rosso' && !isRedWineColorTone(wineSheet.visualExam.color.tone)) {
      wineSheet.visualExam.color.tone = ColorTone.RubyRed;
    }
  });
  
  // Get color tone options based on wine type
  const getColorToneOptions = (): Record<string, string> => {
    if (wineSheet.wineType === 'Bianco') {
      return {
    ...
    } else if (wineSheet.wineType === 'Rosé') {
      return {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      wineSheet.olfactoryExam.aromaTypes = [...selectedAromaTypes.value] as AromaType[];
      ...
      // Emit the submit event with the wine sheet data
      emit('submit', { ...wineSheet });
    } catch (error) {
